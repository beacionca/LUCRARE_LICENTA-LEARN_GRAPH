...
namespace LicentaTest1
{
    public partial class Form8 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string specializare = listBox2.SelectedItem.ToString();
            string anul = listBox3.SelectedItem.ToString();
            string seria = listBox4.SelectedItem.ToString();
            string grupa = listBox5.SelectedItem.ToString();
            string rol = "student";
        ...
        {
            if (listBox2.SelectedItem.ToString() == "Informatica")
            {
                ...
                listBox5.Items.Add("1.2");
                listBox5.Items.Add("2.1");
                listBox5.Items.Add("2.2");
                listBox5.Items.Add("3.1");
                listBox5.Items.Add("3.2");
            }
            else
            {
                listBox3.Items.Add("1");
                ...
                listBox5.Items.Add("3.1");
                listBox5.Items.Add("3.2");
                listBox5.Items.Add("4.1");
                listBox5.Items.Add("4.2");
                listBox5.Items.Add("5.1");
                listBox5.Items.Add("5.2");
                listBox5.Items.Add("6.1");
                listBox5.Items.Add("6.2");
            }
        }
